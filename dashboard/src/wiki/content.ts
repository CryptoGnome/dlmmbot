  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "cards",
        items: [
          { title: "Overview", text: "Money snapshot, open profit with slot occupancy (e.g. 3 of 5 · 2 free) and rent in flight, equity chart. Engine ON/OFF + HALT live in the header. Rent in flight = what open positions paid above their deposit (bin rent + open gas, ~0.06–0.12 SOL each). It IS part of Total balance — it's your SOL, and measured across clean closes ~97% comes back. Open profit marks the liquidity only, so rent is shown there too: wallet + open + rent = Total balance. Without counting it the balance would drop when a position opens and jump when it closes, which tells you nothing about what you're worth.", icon: "chart" },
