    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Build pill = release version + deploy branch + git SHA + sync (CURRENT / BEHIND / …). Auto-detects host: PM2/VPS uses local git; Railway/Vercel/etc use platform deploy SHA + GitHub tip for CURRENT. Auto on/off switch sits next to it (host pulls vs Changes → Approve).",
