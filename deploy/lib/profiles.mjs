...
export const PROFILE_ALLOWLIST = new Set([
  ...
  "sizing.kelly_lookback",
  "sizing.kelly_min_samples",
  "sizing.kelly_cold_start_frac",
  "sizing.kelly_max_position_frac",
  "sizing.kelly_block_negative",
  "sizing.kelly_core_unit",
  "sizing.kelly_core_sol",
  "sizing.kelly_core_pct",
  "sizing.kelly_core_mult",
  "sizing.kelly_micro_unit",
  "sizing.kelly_micro_sol",
  "sizing.kelly_micro_pct",
  "sizing.kelly_micro_mult",
  "sizing.kelly_majors_unit",
  "sizing.kelly_majors_sol",
  "sizing.kelly_majors_pct",
  "sizing.kelly_majors_mult",
  "sizing.kelly_follow_unit",
  "sizing.kelly_follow_sol",
  "sizing.kelly_follow_pct",
  "sizing.kelly_follow_mult",
  "sizing.fixed_core_unit",
  "sizing.fixed_core_sol",
  "sizing.fixed_core_pct",
  "sizing.fixed_micro_unit",
  "sizing.fixed_micro_sol",
  "sizing.fixed_micro_pct",
  "sizing.fixed_majors_unit",
  "sizing.fixed_majors_sol",
  "sizing.fixed_majors_pct",
  "sizing.fixed_follow_unit",
  "sizing.fixed_follow_sol",
  "sizing.fixed_follow_pct",
  "sizing.score_mult_low",
