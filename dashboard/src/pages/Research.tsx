    ...
    <div className="space-y-3">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group relative w-full shrink-0 overflow-hidden border border-accent/50 bg-accent/10 px-3 py-2.5 no-underline transition-colors hover:border-accent hover:bg-accent/15 sm:w-[22rem] sm:max-w-[22rem]"
          ...
          <div className="relative flex items-start gap-2.5">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-[11px] leading-snug text-muted">
                Thread, essay, or playbook — we review with our agent for STRATEGY.
              </p>
              <span className="mt-1.5 inline-flex items-center gap-1 text-[10px] tracking-wider text-accent uppercase">
