    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Analytics", text: "Why we made/lost SOL — exits, sleeves, skips. On the equity chart the line is cumulative equity and the small bars along the floor are each day’s closed P&L on their own scale, like volume under a price chart — a tall bar means a big day relative to other days, not that equity reached that height.", icon: "calc" },
