    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          { title: "Analytics", text: "Why we made/lost SOL — exits, sleeves, skips. On the equity chart the line is cumulative equity — the fill is green above zero and red when the book is underwater — and the thin faint bars on the same zero line are each day’s closed P&L, drawn as texture beneath the line the way a per-trade histogram sits under an equity curve.", icon: "calc" },
